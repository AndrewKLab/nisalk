    ...
    return (
        <ScrollView style={styles.formContainer}>
            ...
            <View style={styles.formInputsContainer}>
                ...
                <Button style={{ marginBottom: 8 }} mode="contained" loading={create_reqest_loading} disabled={selectedValue === ''} onPress={() => sendMessage(theme, message, '', '', '', fileList)}>Отправить</Button>
            </View>
