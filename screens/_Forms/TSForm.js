...
const TSForm = ({ dispatch, navigation, jwt, route, user, create_reqest_loading, create_reqest_error,  requests_type }) => {
    ...
    return (
        <ScrollView style={styles.formContainer}>
            ...
            <View style={styles.formInputsContainer}>
                ...
                <Button style={{ marginBottom: 8 }} mode="contained" loading={create_reqest_loading} disabled={selectedValue === ''} onPress={() => sendMessage(theme, message, mark, model, number, fileList)}>Отправить</Button>
            </View>
