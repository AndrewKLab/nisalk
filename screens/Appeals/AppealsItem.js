...
const AppealsItem = ({ dispatch, navigation, route }) => {
    ...
    const goToForm = (title, theme) => {
        navigation.navigate('AppealsFormScreen', { title: title, theme: theme, ts: item })
    }
...
const connectedAppealsItem = connect(mapStateToProps)(AppealsItem)
export { connectedAppealsItem as AppealsItem };